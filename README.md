...
- **Professional Port Scanner** – TCP/UDP scanning with full **JSON and HTML** reports   |   ![Demo](https://github.com/mahdizebardastbarzin/port-scanner)
...
- **Port Scanner حرفه‌ای** – اسکن TCP/UDP با گزارش کامل **JSON و HTML**   |   ![Demo](https://github.com/mahdizebardastbarzin/port-scanner)
